import COVER_IMAGE from './imgs/cover2.jpg';
    ...
    <div className="w-full h-screen flex flex-col lg:flex-row items-start">
      <div className='relative w-full lg:w-1/2 h-1/2 lg:h-full flex flex-col'>
        <div className='absolute top-[20%] left-[10%] flex flex-col'>
          ...
          <p className='text-xl lg:text-3xl text-white font-bold'>From the ground up, we cultivate hope, health, and a sustainable future.</p>
        </div>
